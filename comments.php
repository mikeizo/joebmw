...
<div id="comments" class="comments-area card">
	...
	<?php if( comments_open() ) : ?>
		<div class="wb-comment-form">
			<?php
				$zeppieri_comment_field = '<div class="comment-form-textarea form-group col-md-12"><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" class="form-control" placeholder="'. esc_attr__('Enter your comment...*', 'wp-bootstrap-4') .'"></textarea></div>';
				$zeppieri_fields =  array(
				...
				comment_form( array(
					...
					'comment_notes_after'  => '',
					'comment_field'        => $zeppieri_comment_field,
					'fields'               => $zeppieri_fields,
				) );
			?>
		</div>
	<?php endif; ?>
